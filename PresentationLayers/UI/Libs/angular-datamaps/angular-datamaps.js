            ...
            link: function(scope, element, attrs) {
                        ...
                        data: {},
                            ...
                            if (angular.isDefined(attrs.onClick)) {
                                ...
                                datamap.svg.selectAll('.datamaps-subunit').on('click', function(geography) {
                                    scope.onClick().call(scope.$parent, geography);
                                    //}
                                });
                            }
                ...
                scope.api = {
                    ...
                    updateWithOptions: function(map) {
                        ...
                        scope.datamap.legend({ defaultFillName: 'Not Available:'});
                    },
                    ...
                    setSelectedCountry: function(newSelection, oldSelection) {
                        
                        // Allow animated transition when geos don't change
                        // or fully refresh
                        if (scope.datamap) {
                            scope.datamap.setSelectedCountry(newSelection, oldSelection);
                        }

                        element.injector().invoke(function ($compile) {
                            var popup = angular.element(element[0].querySelector('.hoverinfo'));
                            var myscope = popup.scope();
                            $compile(popup)(myscope);
                        });
